...
<ToastContainer/>
    ...
    { product.map((data,key) => (
        ...
        <div class="col-4" data-aos="flip-left" data-aos-delay="50" data-aos-duration="1000">
            <div class="products">
            ...
            <img  src={`assets/${data.image}`}/></div>
                ...
                */}
                <button type='submit'  style={{backgroundColor:'#4BB543',borderRadius:'20px', color:'white', border:'none'}} onClick={()=>{addTOcart(data._id)}}>Add To Cart</button><br/><br/>
